...
function Home() {
  ...
  const provinceName =
    temperatureProvince[0]?.nomProvince ||
    selectedProvince;
  ...
  const temperatureTrend =
    temperatureProvince.map(
      (item) => Number(item.temperature)
    );

  const chartData = {
    labels: temperatureProvince.map(
      (item) => item.annee
    ),
        ...
        <div className="row align-items-center g-4">
          <div className="col-lg-8">
            ...
            <p className="lead text-muted mb-0">
              Analyse interactive des températures,
              précipitations et émissions de gaz à effet
              de serre au Canada.
            </p>
          </div>
      ...
      <div className="row g-4 mb-4">
        ...
        <div className="col-md-6 col-xl-3">
          <DashboardKPI
            ...
            value={
              latestPrecipitation !== null
                ? latestPrecipitation.toFixed(2)
                : "--"
            }
            unit="mm"
            color="#0284c7"
        ...
        <div className="col-md-6 col-xl-3">
          <DashboardKPI
            ...
            label="Émissions GES"
            value={
              latestPollution !== null
                ? latestPollution.toFixed(2)
                : "--"
            }
            unit="Mt"
            color="#15803d"
          ...
          <div className="section-card h-100">
            ...
            <div className="p-4">
              ...
              <p className="small text-muted text-center mb-0">
                Cliquez sur une province ou un territoire
                pour actualiser les indicateurs.
              </p>
            </div>
          </div>
        </div>
...
function QuickModule({
  ...
  return (
    ...
    >
      <div
        className="section-card h-100 p-4 module-link"
        style={{
